...
data.frame(source=c(rep("Model",2),rep("Train:Test",2)),Parameter=c("R2adj","RMSE","MAPE","MMA"),
           Mean=c(0.97,0.20,19,84),
           Min=c(0.96,0.17,13,78),
           Max=c(0.98,0.23,28,88))%>%
  flextable()%>%
  font(fontname="Arial",part="all")%>%
  bold(part="header")%>%
  fontsize(size=13,part="header")%>%
...
.small[
\begin{align*}
TN Load_{S79} = 1.76\times 10^{-2} + (6.60\times 10^{-8} Q_{C44 Basin}) + (1.99\times 10^{-7} Q_{S308}) + (1.06\times 10^{-2} ln(Q_{S80}))\\ - (1.70x10^{-2} Mean  Stage)
\end{align*}
]
...
```{r}
data.frame(source=c(rep("Model",2),rep("Train:Test",2)),Parameter=c("R2adj","RMSE","MAPE","MMA"),
           Mean=c(0.97,0.19,19,85),
           Min=c(0.96,0.14,9,80),
           Max=c(0.99,0.24,26,92))%>%
  flextable()%>%
  font(fontname="Arial",part="all")%>%
  bold(part="header")%>%
  fontsize(size=13,part="header")%>%
